const triviaQuestions = [
  ...
  {
    question:
      "(+1 pt) Who is Steph Curry's father and which team did he play for (the longest)?",
    answer: "Dell Curry/Charlotte Hornets",
    options: [
      "Dell Curry/Toronto Raptors",
      "Simon Curry/Golden State Warriors",
      "Simon Curry/Portland Blazers",
      "Dell Curry/Charlotte Hornets",
      "Raymond Curry/Washington Bullets"
    ]
  },
  {
    question:
      "(+1 pt) Per NBA rules, how many timeouts does each team have in overtime?",
    answer: "2",
  ...
  {
    question:
      "(+2 pts) Who was the first African-American player to play in the NBA?",
    answer: "Earl Lloyd",
    options: [
      "Earl Lloyd",
      "Wilt Chamberlain",
  ...
  {
    question:
      "(+1 pt) Who holds the record for being the shortest player in the NBA?",
  ...
  },
  {
    ...
    options: [
      "National Basketball of America",
      "National Basketball Association",
      "New Basketball Age",
      "Nationwide Basketball Association",
      "National Basketball Athletics"
    ]
  },
  {
  ...
  {
    question:
      "(+1 pt) Who was the last Boston Celtics coach to lead the team to two straight NBA titles?",
    answer: "Bill Russell",
    options: [
      "Bill Russell",
      "Fred Hoiberg",
  ...
  {
    question: "(+1 pt) As of 2019, who is the current oldest NBA player?",
    answer: "Vince Carter",
    options: [
      "Carmelo Anthony",
      "Vince Carter",
  ...
  {
    question:
      "(+1 pt) What is the name of the trophy awarded to the NBA champions?",
